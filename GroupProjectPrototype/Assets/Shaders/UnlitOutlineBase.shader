...
Shader "Tib/UnlitBase"
{
	Properties
	{
		...
		[Toggle(_CHANGEOUTLINESTYLE_ON)] _ChangeOutlineStyle("Change Outline Style", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature _CHANGEOUTLINESTYLE_ON
		...
		{
			UNITY_INITIALIZE_OUTPUT( Input, o );
			#ifdef _CHANGEOUTLINESTYLE_ON
				float3 staticSwitch88 = 0;
			#else
				float3 staticSwitch88 = 0;
			#endif
			v.vertex.xyz += staticSwitch88;
		}
...
/*ASEBEGIN
Version=17000
7;1;1906;1011;1271.338;277.2813;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-1390.227,-134.8329;Float;False;Property;_NoiseMapOpacity;NoiseMapOpacity;8;0;Create;True;0;0;False;0;0;0.32;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;84;-1212.216,-808.4135;Float;False;Property;_AlbedoColor;AlbedoColor;12;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;80;-884.4589,341.8006;Float;False;Property;_OutLineColor;OutLine Color;11;0;Create;True;0;0;False;0;0,0,0,0;0.3207547,0.03479887,0.0505655,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-873.7058,511.062;Float;False;Property;_OutlineWidth;OutlineWidth;10;0;Create;True;0;0;False;0;0;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OutlineNode;91;-615.0054,549.0187;Float;False;1;True;None;0;0;Front;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
...
WireConnection;72;11;88;0
ASEEND*/
//CHKSM=3DD0C103C488ADAF54135A7317C3D916452C903B